...
load("~/Documents/PhD/updated MCS datasets/education-datasets/2021-12-17_vocabulary_education_imputedRQ1/2021-12-17_vocabulary_education_imputedRQ1.Rdata")
imputed_mcs2 = mi.res
...
#pooled results of models 
NVQ_moderatorSensitivityResults = summary(pool(NVQ_moderatorSensitivity), conf.int = TRUE, exponentiate = TRUE)
...
occupation_moderatorSensitivity = with(imputed_mcs2, glm(success ~ sex + ethnicity + EAL + country +
                                                    ...
                                                    occupational_status*age5_standardised +occupational_status*occupational_status +
...
#pooled results of models 
occupation_moderatorSensitivityResults = summary(pool(occupation_moderatorSensitivity), conf.int = TRUE, exponentiate = TRUE)
...
#pooled results of models 
income_moderatorSensitivityResults = summary(pool(income_moderatorSensitivity), conf.int = TRUE, exponentiate = TRUE)
...
#pooled results of models 
wealth_moderatorResultsSensitivity = summary(pool(wealth_moderatorSensitivity), conf.int = TRUE, exponentiate = TRUE)
...
#pooled results of models 
imd_moderatorResultsSensitivity  = summary(pool(imd_moderatorSensitivity ), conf.int = TRUE, exponentiate = TRUE)
