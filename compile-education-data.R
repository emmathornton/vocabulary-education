...
analysis_data = merge(all=TRUE, analysis_data, education_outcomesWelsh, by = "mcsid")
analysis_data = merge(all=TRUE, analysis_data, exploratory_education, by = "mcsid")
...
write.csv(mcs_analysis, file = "education_data1.csv")
...
#save full cohort sample as a csv file- to get descriptives
write.csv(analysis_data, file = "cohort_data1.csv")
