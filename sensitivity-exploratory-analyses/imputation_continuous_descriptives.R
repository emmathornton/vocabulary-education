...
meth[c("average_grade", "average_grade_n5")]="cart" 
...
write.mice.imputation(mi.res=imputed_mcs2, name = glue("{today()}_vocabulary_education_imputedContinuousDescriptives"),include.varnames = TRUE, long=TRUE,dattype = "csv", mids2spss = FALSE)
