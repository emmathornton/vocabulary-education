...
#open mcs data####
vocabulary_education<-read.csv("exploratory_analysisData.csv")
...
meth[c("standardised_english", "standardised_maths", "standardised_science")]="cart" 
...
vis = c("mcsid", "weight","sex","ethnicity","EAL","age_atBirth","housing_tenure","accommodation_type" , 
        ...
        "age5_vocab","standardised_english", "standardised_maths", "standardised_science")
...
write.mice.imputation(mi.res=imputed_mcs2, name = glue("{today()}_vocabulary_education_exploratoryAnalysis_imputedData"),include.varnames = TRUE, long=TRUE,dattype = "csv", mids2spss = FALSE)
