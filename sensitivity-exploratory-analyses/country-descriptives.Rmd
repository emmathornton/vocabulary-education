...
continuous_outcomeDescriptivesEngland = weighted_descriptives_imputed_datasets(long_format_england, standardised_core_subjects)
...
combined_caregiverVocabDescriptivesEngland = round(combine_imputed_descriptives(caregiverVocabDescriptivesEngland),2) %>% 
  select(!Imputed) %>% 
  slice_head(n=1)
combined_continuousOutcomeDescriptivesEngland = round(combine_imputed_descriptives(continuous_outcomeDescriptivesEngland),2) %>% 
  select(!Imputed) %>% 
  slice_head(n=1)
...
continuous_outcomeDescriptivesWales = weighted_descriptives_imputed_datasets(long_format_wales, standardised_core_subjects)
...
combined_caregiverVocabDescriptivesWales = round(combine_imputed_descriptives(caregiverVocabDescriptivesWales),2) %>% 
  select(!Imputed) %>% 
  slice_head(n=1)
combined_continuousOutcomeDescriptivesWales = round(combine_imputed_descriptives(continuous_outcomeDescriptivesWales),2) %>% 
  select(!Imputed) %>% 
  slice_head(n=1)
...
continuous_outcomeDescriptivesScotland = weighted_descriptives_imputed_datasets(long_format_scotland, standardised_core_subjects)
...
combined_caregiverVocabDescriptivesScotland = round(combine_imputed_descriptives(caregiverVocabDescriptivesScotland),2) %>% 
  select(!Imputed) %>% 
  slice_head(n=1)
combined_continuousOutcomeDescriptivesScotland = round(combine_imputed_descriptives(continuous_outcomeDescriptivesScotland),2) %>% 
  select(!Imputed) %>% 
  slice_head(n=1)
...
continuous_outcomeDescriptivesNI = weighted_descriptives_imputed_datasets(long_format_NI, standardised_core_subjects)
...
combined_caregiverVocabDescriptivesNI = round(combine_imputed_descriptives(caregiverVocabDescriptivesNI),2) %>% 
  select(!Imputed) %>% 
  slice_head(n=1)
combined_continuousOutcomeDescriptivesNI = round(combine_imputed_descriptives(continuous_outcomeDescriptivesNI),2) %>% 
  select(!Imputed) %>% 
  slice_head(n=1)
...
continuous_outcomeDescriptivesEngland = combined_continuousOutcomeDescriptivesEngland  %>% add_column(paste0(combined_continuousOutcomeDescriptivesEngland$Mean,"(±",combined_continuousOutcomeDescriptivesEngland$SD,")", "\n", "[", combined_continuousOutcomeDescriptivesEngland$lower, ";", combined_continuousOutcomeDescriptivesEngland$upper,"]")) %>% 
...
descriptivesTableEngland = rbind(vocabDescriptivesEngland, caregiverVocabDescriptivesEngland, benchmarkCombinedEngland, continuous_outcomeDescriptivesEngland, 
...
continuous_outcomeDescriptivesWales = combined_continuousOutcomeDescriptivesWales  %>% add_column(paste0(combined_continuousOutcomeDescriptivesWales$Mean,"(±",combined_continuousOutcomeDescriptivesWales$SD,")", "\n", "[", combined_continuousOutcomeDescriptivesWales$lower, ";", combined_continuousOutcomeDescriptivesWales$upper,"]")) %>% 
  rename("contOutcome" = `paste0(...)`) %>% 
  add_column("Variable" = "Continuous Outcome") %>% 
  select(Variable, contOutcome)  %>% 
  rename("Proportion (%) or \n Mean(±SD) [95% CIs]" = contOutcome) 
...
descriptivesTableWales = rbind(vocabDescriptivesWales, caregiverVocabDescriptivesWales, benchmarkCombinedWales, continuous_outcomeDescriptivesWales, 
...
continuous_outcomeDescriptivesScotland = combined_continuousOutcomeDescriptivesScotland  %>% add_column(paste0(combined_continuousOutcomeDescriptivesScotland$Mean,"(±",combined_continuousOutcomeDescriptivesScotland$SD,")", "\n", "[", combined_continuousOutcomeDescriptivesScotland$lower, ";", combined_continuousOutcomeDescriptivesScotland$upper,"]")) %>% 
  rename("contOutcome" = `paste0(...)`) %>% 
  add_column("Variable" = "Continuous Outcome") %>% 
  select(Variable, contOutcome)  %>% 
  rename("Proportion (%) or \n Mean(±SD) [95% CIs]" = contOutcome) 
...
descriptivesTableScotland = rbind(vocabDescriptivesScotland, caregiverVocabDescriptivesScotland, benchmarkCombinedScotland, continuous_outcomeDescriptivesScotland, 
...
continuous_outcomeDescriptivesNI = combined_continuousOutcomeDescriptivesNI  %>% add_column(paste0(combined_continuousOutcomeDescriptivesNI$Mean,"(±",combined_continuousOutcomeDescriptivesNI$SD,")", "\n", "[", combined_continuousOutcomeDescriptivesNI$lower, ";", combined_continuousOutcomeDescriptivesNI$upper,"]")) %>% 
  rename("contOutcome" = `paste0(...)`) %>% 
  add_column("Variable" = "Continuous Outcome") %>% 
  select(Variable, contOutcome)  %>% 
  rename("Proportion (%) or \n Mean(±SD) [95% CIs]" = contOutcome) 
...
descriptivesTableNI = rbind(vocabDescriptivesNI, caregiverVocabDescriptivesNI, benchmarkCombinedNI, continuous_outcomeDescriptivesNI, 
