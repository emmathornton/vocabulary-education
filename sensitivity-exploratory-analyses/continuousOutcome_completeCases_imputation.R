...
#open mcs data####
vocabulary_education<-read.csv("continuous_educationComplete_data.csv")
...
write.mice.imputation(mi.res=imputed_mcs2, name = glue("{today()}_vocabulary_education_continuousOutcomeComplete"),include.varnames = TRUE, long=TRUE,dattype = "csv", mids2spss = FALSE)
