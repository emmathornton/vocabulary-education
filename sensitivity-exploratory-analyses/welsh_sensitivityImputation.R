...
#open mcs data####
vocabulary_education<-read.csv("education_dataWelsh.csv")
...
meth[c("benchmark_binary_welsh")]="logreg"
meth[c("standardised_core_subjectsWelsh")]="cart" 
...
vis = c("mcsid", "weight","sex","ethnicity","EAL","age_atBirth","housing_tenure","accommodation_type" , 
        ...
        "age5_vocab","benchmark_binary_welsh", "standardised_core_subjectsWelsh")
...
write.mice.imputation(mi.res=imputed_mcs2, name = glue("{today()}_vocabulary_education_welshSensitivity"),include.varnames = TRUE, long=TRUE,dattype = "csv", mids2spss = FALSE)
