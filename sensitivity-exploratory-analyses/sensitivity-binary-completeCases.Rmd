...
load("~/Documents/PhD/updated MCS datasets/education-datasets/2021-12-20_vocabulary_education_binaryOutcomeCompleteCases/2021-12-20_vocabulary_education_binaryOutcomeCompleteCases.Rdata")
imputed_mcs2 = mi.res
```
...
results_binaryCC <- regression_resultsTable %>% 
 ...
 add_header_row(values = c(" ", "Binary Outcome (OR[95% CIs])"), colwidths = c(1, 3)) %>% 
  ...
  add_header_lines(values = c("Table S1: Predicting Educational Attainment (≥grade 4 on core subjects, complete cases) (N=9,866)"))
