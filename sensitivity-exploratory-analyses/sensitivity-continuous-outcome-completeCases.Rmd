...
load("~/Documents/PhD/updated MCS datasets/education-datasets/2021-12-20_vocabulary_education_continuousOutcomeComplete/2021-12-20_vocabulary_education_continuousOutcomeComplete.Rdata")
imputed_mcs2 = mi.res
...
results_continuousCC <- regression_resultsTable %>% 
 ...
 add_header_row(values = c(" ",  "Continuous Outcome (B[95% CIs]"), colwidths = c(1, 3)) %>% 
  ...
  add_header_lines(values = c("Table S2: Predicting Educational Attainment (average grade on core subjects, complete cases) (N=7,664)"))
