...
load("~/Documents/PhD/updated MCS datasets/education-datasets/2021-12-20_vocabulary_education_countrySpecificData/2021-12-20_vocabulary_education_countrySpecificData.Rdata")
imputed_mcs2 = mi.res
```
...
#get probabilities
composite_quintiles_england = lapply(compositeQuintiles_england, ggpredict, terms = c("age5_standardised", "composite_quintiles"))
...
#get probabilities
composite_quintiles_wales = lapply(compositeQuintiles_wales, ggpredict, terms = c("age5_standardised", "composite_quintiles"))
...
#get probabilities
composite_quintiles_scotland = lapply(compositeQuintiles_scotland, ggpredict, terms = c("age5_standardised", "composite_quintiles"))
...
composite_quintiles_northern_ireland = lapply(compositeQuintiles_northern_ireland, ggpredict, terms = c("age5_standardised", "composite_quintiles"))

#plot 
 
england_plot = plot(pool_predictions(composite_quintiles_england), ci = FALSE,
                               limits = c(0, 1), 
...
wales_plot = plot(pool_predictions(composite_quintiles_wales), ci = FALSE,
                               limits = c(0, 1), 
                               breaks = seq(0, 1, by = 0.1)) +
  scale_colour_manual(values=c("#054a91", "#6596c1","#9dbcd7" , "#f6a55c", "#f17300"), 
                      name="SEC Composite", 
...
scotland_plot = plot(pool_predictions(composite_quintiles_scotland), ci = FALSE,
                               limits = c(0, 1), 
                               breaks = seq(0, 1, by = 0.1)) +
  scale_colour_manual(values=c("#054a91", "#6596c1","#9dbcd7" , "#f6a55c", "#f17300"), 
                      name="SEC Composite", 
...
NI_plot = plot(pool_predictions(composite_quintiles_northern_ireland), ci = FALSE,
                               limits = c(0, 1), 
                               breaks = seq(0, 1, by = 0.1)) +
  scale_colour_manual(values=c("#054a91", "#6596c1","#9dbcd7" , "#f6a55c", "#f17300"), 
                      name="SEC Composite", 
...
plots = annotate_figure(plots, top = text_grob("Figure S2: Predicted Probabilities of Achieving the Benchmark Threshold for Vocabulary Moderated by SEC in each country", 
...
ggsave("country-interaction-plots.png", plots, width=15, height=10, units= "in" ,dpi=300)
```
